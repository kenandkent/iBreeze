...
def _raise(exc: ValueError) -> None:
    ...
    if code == "User not found":
        raise_problem(404, "USER_NOT_FOUND", code)
    if "protected" in code.lower():
        raise_problem(403, "PROTECTED_USER_OPERATION_DENIED", code)
    if "Invalid cursor" in code:
        raise_problem(400, "INVALID_CURSOR", code)
    raise_problem(400, "USER_OPERATION_FAILED", code)
